    ...
    <div>
        <div className="home">
            <div className="home_container">
                {/* <img src="../images/ecommerce.jpg" alt="" className="home_img" /> */}
                <img src="https://www.x-cart.com/wp-content/uploads/2019/01/ecommerce-768x278.jpg" alt="" className="home_img" />
